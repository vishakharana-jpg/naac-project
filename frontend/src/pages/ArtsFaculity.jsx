...
const departments = [
  { id: "economics",   name: "Economics",                      icon: "📈", color: { active: "#059669", light: "#D1FAE5", border: "#A7F3D0", text: "#065F46" } },
  { id: "english",     name: "English",                        icon: "📖", color: { active: "#7C3AED", light: "#EDE9FE", border: "#DDD6FE", text: "#5B21B6" } },
  { id: "hindi",       name: "Hindi",                          icon: "🔤", color: { active: "#DC2626", light: "#FEE2E2", border: "#FECACA", text: "#991B1B" } },
  { id: "history",     name: "History",                        icon: "🏛️", color: { active: "#D97706", light: "#FEF3C7", border: "#FDE68A", text: "#92400E" } },
  { id: "homescience", name: "Home Science",                   icon: "🏠", color: { active: "#DB2777", light: "#FCE7F3", border: "#FBCFE8", text: "#9D174D" } },
  { id: "music",       name: "Music",                          icon: "🎵", color: { active: "#0891B2", light: "#CFFAFE", border: "#A5F3FC", text: "#0E7490" } },
  { id: "physed",      name: "Physical Education",             icon: "⚽", color: { active: "#16A34A", light: "#DCFCE7", border: "#BBF7D0", text: "#15803D" } },
  { id: "polsci",      name: "Political Science",              icon: "🏛️", color: { active: "#4F46E5", light: "#E0E7FF", border: "#C7D2FE", text: "#3730A3" } },
  { id: "sanskrit",    name: "Sanskrit",                       icon: "📜", color: { active: "#B45309", light: "#FEF3C7", border: "#FDE68A", text: "#78350F" } },
  { id: "sociology",   name: "Sociology",                      icon: "👥", color: { active: "#0284C7", light: "#E0F2FE", border: "#BAE6FD", text: "#075985" } },
  { id: "journalism",  name: "Journalism & Mass Media",        icon: "📰", color: { active: "#374151", light: "#F3F4F6", border: "#E5E7EB", text: "#1F2937" } },
  { id: "yoga",        name: "Yoga",                           icon: "🧘", color: { active: "#7C3AED", light: "#F5F3FF", border: "#DDD6FE", text: "#5B21B6" } },
